...
public class TicTacToeGame {
    ...
    public TicTacToeBlock[][] blocksData = new TicTacToeBlock[3][3]; // Parameter this
    public JButton[][] blocks = new JButton[3][3]; // Parameter  this for extension
    ...
    public int movesLeft = 9; // to be increased for extension
    ...
    public TicTacToeGame() {
        ...
        JPanel game = new JPanel(new GridLayout(3,3)); // Parameter for extension
